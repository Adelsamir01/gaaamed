...
export const GAMES: GameDef[] = [
  ...
  },
  {
    id: 'snake',
    name: 'الثعبان',
    description: 'عالم مفتوح بلا حواف — اجمع الأكل الملون، كبّر ثعبانك، وتصدر الساحة',
    emoji: '🐍',
    category: 'سرعة',
    howToPlay: [
      ...
      'العالم مفتوح بلا حواف؛ في اللعب الفردي تجنّب جسمك، وفي الساحة العامة يمكنك عبور جسمك بأمان',
      'أونلاين: تموت فقط عندما يصطدم رأسك بجسم ثعبان آخر، ويصبح جسم الثعبان المهزوم أكلًا للجميع',
      'دوس مطولًا على زر «سرعة» في الساحة العامة عندما تحتاج دفعة إضافية',
    ],
    supportsBot: false,
    supportsTwoPlayer: false,
    singlePlayer: true,
